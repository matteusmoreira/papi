...
export type CarouselCard = {
    header?: {
        imageUrl?: string;
        videoUrl?: string;
        imageMessage?: WAProto.Message.IImageMessage;
        videoMessage?: WAProto.Message.IVideoMessage;
...
export declare const generateCarouselMessage: (options: CarouselMessageOptions) => WAProto.Message.IInteractiveMessage;
export declare const generateListMessage: (sections: any[], buttonText: string, text: string, title: string, footer: string) => WAProto.Message.IInteractiveMessage;
/**
 * Gera listMessage no formato legado (funciona no desktop)
 */
export declare const generateListMessageLegacy: (sections: any[], buttonText: string, text: string, title: string, footer: string) => WAProto.Message.IListMessage;
export declare const generateButtonMessage: (buttons: any[], text: string, footer: string, headerType: any, mediaUrl: string) => WAProto.Message.IInteractiveMessage;
/**
 * Gera buttonsMessage no formato legado (funciona no desktop)
 * Nota: Apenas botões de resposta simples são suportados no formato legado
 */
export declare const generateButtonMessageLegacy: (buttons: any[], text: string, footer: string) => WAProto.Message.IButtonsMessage;
/**
 * Patch message for MD (Multi-Device) to make buttons/list work on mobile
 * Wraps the message in viewOnceMessage when needed
 */
export declare const patchMessageForMdIfRequired: (message: WAProto.IMessage) => WAProto.IMessage;
export {};
